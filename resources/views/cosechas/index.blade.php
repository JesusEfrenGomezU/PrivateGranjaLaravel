    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-1">
                    <a href="{{ route('cosechas.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i></a>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                    @foreach ($cosechas as $cosecha)
                        <tr>
                            <td>{{ $cosecha->id }}</td>
                            <td>{{ $cosecha->CodigoCultivo }}</td>
                            <td>{{ $cosecha->Usuario }}</td>
